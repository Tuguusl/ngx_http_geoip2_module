...
uint32_t ngx_http_get_forwarded_addr_first_non_private_ip(ngx_http_request_t *r, ngx_addr_t *addr,
...
uint32_t ngx_http_get_forwarded_addr_first_non_private_ip_internal(ngx_http_request_t *r, ngx_addr_t *addr,
